...
public class CompraServiceParticoesTest {
	...
	public void deveCalcularCustoTotalCorretamente(
		...
		produto1.setPreco(new BigDecimal("5"));
		produto1.setPesoFisico(new BigDecimal("50"));
		...
		produto4.setPesoFisico(new BigDecimal("5.0"));
		...
		produto5.setPreco(new BigDecimal("510.00"));
